...
integration_tests! {
    ...
    test_code_review_composer_opens_inline_and_pushes_line,
    test_code_review_composer_save_via_button,
    test_code_review_composer_typing_routes_to_composer,
    test_code_review_composer_cmd_enter_saves,
    test_code_review_composer_cancel_and_escape,
    test_code_review_composer_reopen_and_remove,
    test_code_review_composer_floating_when_flag_off,
    test_code_review_composer_height_tracks_content,
    test_code_review_general_composer_stays_overlay,
    test_code_review_composer_scrolls_with_line,
    test_code_review_scroll_anchor_preserved_with_comment_block,
    test_code_review_saved_comment_renders_inline_after_save,
    test_code_review_saved_comment_external_upsert_renders_inline,
    test_code_review_saved_comment_panel_parity,
    test_code_review_saved_comment_full_lifecycle,
    test_code_review_saved_comment_imported_from_github,
    test_code_review_comment_on_first_line,
    test_code_review_comment_on_last_line,
    test_code_review_offscreen_block_reserves_space,
    test_code_review_composer_replaces_saved_card_on_same_line,
    test_code_review_current_to_outdated_removes_inline_block,
    test_code_review_very_tall_comment_is_scrollable,
    test_code_review_saved_comment_jump_scrolls_card_into_view,
    test_code_review_saved_comment_survives_diff_recompute,
    test_code_review_saved_comment_flag_off_no_inline_block,
    test_code_review_saved_comment_reflows_on_width_change,
    test_code_review_saved_comment_survives_diff_mode_switch,
    test_code_review_saved_comment_has_no_embedded_diff_snippet,
    test_code_review_gutter_add_comment_opens_composer,
    test_code_review_inline_card_event_routing_and_cursor_isolation,
