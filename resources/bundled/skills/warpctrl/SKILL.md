...
- Invoke close actions only when the user explicitly asks to close something. `window close`, `tab close`, and `pane close` use normal Warp close behavior and may show existing app warnings.
